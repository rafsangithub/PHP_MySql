...
<table align="center" cellpadding="0" bgcolor="#FFFFFF" width="800" border="0">
  ...
  <p align="center">
    <?php 
	 $myccode=$_REQUEST['ccode'];
	 $myctitle=$_REQUEST['ctitle'];
	 $mycredit=$_REQUEST['credit'];
	 ...
	 $query="UPDATE me SET ='".$myroll."', sem='".$mysem."', cgpa='".$mycgpa."', bkl1='".$mybkl1."', bkl2='".$mybkl2."' WHERE id='".$id."'";
