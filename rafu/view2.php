  ...
  <p align="center">
    <?php 
	 ...
	 $query="SELECT * FROM me";
		...
		<tr>
		<td><b>Course Code</b></td> <td><b>Course Title</b></td><td><b>Credit</b></td><td><b>Action</b></td></tr> ";
while($result=mysql_fetch_array($resource))
	{ 
	echo "<tr><td>".$result[0]."</td><td>".$result[1]."</td><td>".$result[2]."</td>
	<a href=\"modify2.php?id=".$result[1]."\"><img border=\"0\" src=\"images/cooltext457953689.png\"/></a>
	</td></tr>";
	} echo "</table>";
	 ?>
  ...
  <p align="center">&nbsp;</p>
      <p align="center"><a href="admin.php"><img border="0" src="images/cooltext457951462.png" onmouseover="this.src='images/cooltext457951462MouseOver.png';" onmouseout="this.src='images/cooltext457951462.png';" /></a><a href="view.php"><img border="0" src="images/cooltext457951615.png" onmouseover="this.src='images/cooltext457951615MouseOver.png';" onmouseout="this.src='images/cooltext457951615.png';" /></a></p>
    <p align="center"><a href=""><img border="0" src="" width="395" height="32" alt="Developed By ICT,MBSTU." /></a></p></td>
  </tr>
</table>
