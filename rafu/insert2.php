...
<body background="images/bbb.png">
...
<table align="center" cellpadding="0" bgcolor="#FFFFFF" width="800" border="0">
  ...
  <p align="center">
    <?php 
	 ...
	 $query="INSERT INTO students (rollno,sem, cgpa, bkl1,bkl2) values('".$myroll."', '".$mysem."', '".$mycgpa."','".$mybkl1."', '".$mybkl2."' )";
